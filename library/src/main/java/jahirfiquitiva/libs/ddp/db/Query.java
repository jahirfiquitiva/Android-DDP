package jahirfiquitiva.libs.ddp.db;
...
/**
 * A query can be executed to find a specified number of documents, after any number of requirements
 * has been supplied before
 */
public interface Query {
    ...
    /**
     * Adds a filter to the query requiring the given field to have a value other than the
     * specified
     * one
     *
     * @param fieldName
    ...
    /**
     * Adds a filter to the query requiring the given field to have a value less than the specified
     * value
     *
     * @param fieldName
     *         the name of the field to check
    ...
    /**
     * Adds a filter to the query requiring the given field to have a value less than or equal to
     * the specified value
     *
     * @param fieldName
     *         the name of the field to check
    ...
    /**
     * Adds a filter to the query requiring the given field to have a value greater than the
     * specified value
     *
     * @param fieldName
     *         the name of the field to check
    ...
    /**
     * Adds a filter to the query requiring the given field to have a value greater than or equal to
     * the specified value
     *
     * @param fieldName
     *         the name of the field to check
    ...
    /**
     * Adds a filter to the query requiring the given field to have `null` as its value (or no
     * value)
     *
     * @param fieldName
     *         the name of the field to check
    ...
    /**
     * Adds a filter to the query requiring the given field to have a value different from all the
     * specified ones
     *
     * @param fieldName
     *         the name of the field to check
     ...
     *         the maximum number of entries to return
     * @param offset
     *         the number of entries to skip at the beginning
     *
     * @return an array (never `null`) containing zero or more matches
     */
