...
public interface DdpCallback {
     ...
     *         the modified fields of the document as a JSON string
     * @param removedValuesJson
     *         the deleted fields of the document as a JSON string
     */
    void onDataChanged(String collectionName, String documentID, String updatedValuesJson,
